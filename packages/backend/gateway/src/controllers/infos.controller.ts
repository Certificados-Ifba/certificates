...
import { ListCertificateResponseDto } from 'src/interfaces/certificate/dto/list-certificate-response.dto'
import { ListCertificateDto } from 'src/interfaces/certificate/dto/list-certificate.dto'
